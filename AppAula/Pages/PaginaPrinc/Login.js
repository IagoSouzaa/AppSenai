...
function Login(props) {
  ...
  const login = () => {
    ...
    if (Login(user)) navigation.navigate("Users");
  };
...
function Inscrever() {
  ...
  const verifyData = () => {
    if (!name || !email || !age || !password || !repassword || !gender)
      return false;
  ...
  return (
    <>
      <View style={styles.main}>
        <Text style={styles.defaultText}>SingUp your new account</Text>
        <Image
          style={styles.image}
          source={{
            uri: "https://static.vecteezy.com/ti/vetor-gratis/p3/1840618-imagem-perfil-icone-masculino-icone-humano-ou-pessoa-sinal-e-simbolo-gratis-vetor.jpg",
          }}
        />
        <View>
          <View style={styles.inputContainer}>
